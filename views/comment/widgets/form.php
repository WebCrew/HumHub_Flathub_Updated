...
<div id="comment_create_form_<?= $id ?>" class="comment_create" data-ui-widget="comment.Form"
    ...
    <div class="comment-create-input-group">
		...
		<div id="comment_create_upload_progress_<?= $id ?>" style="display:none;margin:10px 12px 12px 7px;"></div>

    <?= FilePreview::widget([
        'id' => 'comment_create_upload_preview_' . $id,
        'options' => ['style' => 'margin:10px 12px 12px 7px'],
        'edit' => true
    ]) ?>
		
        <div class="comment-buttons">
			<div class="comment-frame"><?php
